...
/**
 * wrapper class which contains a list of parsed elements and a list of
 * {@link AddReferencesItem}s. both have to be added to the {@link AddressSpace}
 * 
 * @author harald
 *
 */
public class ParsedElement {
	...
	private final List<AddReferencesItem> refItems;
