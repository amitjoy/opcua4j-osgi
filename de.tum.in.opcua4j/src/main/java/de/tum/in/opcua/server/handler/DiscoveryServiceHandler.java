...
public class DiscoveryServiceHandler implements DiscoveryServiceSetHandler {
	...
	private static final Logger LOG = Logger
			.getLogger(DiscoveryServiceHandler.class);
	...
	public void onGetEndpoints(
		...
		final GetEndpointsResponse resp = new GetEndpointsResponse();
		...
		respHeader.setRequestHandle(req.getRequest().getRequestHeader()
				.getRequestHandle());
		...
		final List<EndpointDescription> matchingEndpoints = server
				.getEndpointDescriptionsForUri(req.getRequest()
						.getEndpointUrl());
