...
/**
 * 
 * TODO introduce ISession interface which only supports read access to several
 * properties. like continuation points and so on.
 * 
 * @author harald
 *
 */
public class Session {
	...
	/**
	 * indicates if the {@link Session} was already activated by an valid
	 * {@link ActivateSessionRequest}. only if it is active it can be used and
	 * requests are served to the owning client.
	 */
	...
	/**
	 * @param maxRespMsgSize
	 *            the maxRespMsgSize to set
	 */
	...
	public String toString() {
		return "Session [sessionName=" + sessionName + ", sessionID="
				+ sessionID + ", secureChannel=" + secureChannel
				+ ", authenticationToken=" + authenticationToken + ", timeout="
				+ timeout + ", maxRespMsgSize=" + maxRespMsgSize + "]";
	}
